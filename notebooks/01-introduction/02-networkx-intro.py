...
def _(mo):
    ...
    tour = wigglystuff.CellTour(
        steps=[
        {'cell': 0, 'title': 'The NetworkX API', 'description': 'Load real graph data and learn to query nodes, edges, and metadata.'},
        {'cell': 5, 'title': 'Data Model', 'description': 'Graphs store data in a dictionary-like fashion under G.nodes and G.edges.'},
        {'cell': 6, 'title': 'The Seventh-Grader Dataset', 'description': 'A social network of 29 students with proximity-based directed edges.'},
        {'cell': 9, 'title': 'Basic Statistics', 'description': 'Check graph type, node count, and edge count as a sanity check on your data.'},
        {'cell': 14, 'title': 'Querying Nodes', 'description': 'Use G.nodes() and data=True to inspect nodes and their metadata.'},
        {'cell': 22, 'title': 'Exercise: Node Metadata', 'description': 'Count how many males and females are represented in the graph.'},
        {'cell': 28, 'title': 'Querying Edges', 'description': 'Use G.edges() and data=True to inspect edges and their attributes.'},
        {'cell': 37, 'title': 'Exercise: Edge Metadata', 'description': 'Verify the maximum edge weight by iterating over edge data.'},
        {'cell': 41, 'title': 'Manipulating Graphs', 'description': 'Add nodes and edges with metadata using add_node and add_edge.'},
        {'cell': 45, 'title': 'Coding Patterns', 'description': 'Idiomatic list comprehensions for iterating over nodes and edges in NetworkX.'},
        {'cell': 49, 'title': 'Exercise: Unrequited Friendships', 'description': 'Find directed edges where the reverse edge does not exist — a real-world graph puzzle.'},
    ],
        auto_start=False,
        show_progress=True,
    )
...
def _(mo):
    mo.md(
        "Watch the [video on YouTube](https://www.youtube.com/watch?v=sdF0uJo2KdU)."
    )
    return
