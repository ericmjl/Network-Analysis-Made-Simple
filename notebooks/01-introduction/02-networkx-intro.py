...
def _(mo):
    ...
    tour = wigglystuff.CellTour(
        ...
        {'cell': 5, 'title': 'Data Model', 'description': 'Graphs store data in a dictionary-like fashion.'},
        {'cell': 6, 'title': 'Load Data', 'description': 'The 7th-grader social network dataset.'},
        {'cell': 22, 'title': 'Node metadata', 'description': 'Query and count node attributes like gender.'},
        {'cell': 32, 'title': 'Edge metadata', 'description': 'Inspect edge attributes and verify max counts.'},
        {'cell': 41, 'title': 'Manipulating graphs', 'description': 'Add nodes and edges to the graph.'},
        {'cell': 45, 'title': 'Coding patterns', 'description': 'List comprehensions for iterating over nodes and edges.'},
    ],
        auto_start=False,
        show_progress=True,
    )
